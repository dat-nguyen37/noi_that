            ...
            <div class="flex items-center gap-5 dark:bg-black dark:text-white">
                <div class=" flex justify-center items-center gap-2 relative">
                    ...
                    <div v-else id="login" :class="login ?'flex':'hidden'"  class="fixed flex justify-center items-center z-20 inset-0 bg-black bg-opacity-50 h-[100vh] w-[100vw]">
                        <div class="overflow-hidden bg-white w-full sm:w-[23rem] relative">
                            <div @click="openLogin" class="absolute top-0 right-0 p-2 cursor-pointer"><VueIcon type="mdi" :path="mdiClose" size="30" class="text-black"/></div>
